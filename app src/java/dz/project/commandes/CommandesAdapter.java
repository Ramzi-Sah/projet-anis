...
//        TextView livreur_status_txt;
        ...
        ViewHolder(View itemView) {
            ...
            commande_uid_txt = itemView.findViewById(R.id.commande_uid_txt);
...
//            livreur_status_txt = itemView.findViewById(R.id.livreur_livreur_status_txt);
    ...
    //----------------------------------------------------------------------------------------------
    @Override
    public CommandesAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        Context context = parent.getContext();
        LayoutInflater inflater = LayoutInflater.from(context);

        View contactView = inflater.inflate(R.layout.list_item_commande, parent, false);
    ...
    @Override
    public void onBindViewHolder(CommandesAdapter.ViewHolder viewHolder, int position) {
        final Commande commande = commandes.get(position);

        final TextView commande_uid_txt = viewHolder.commande_uid_txt;
